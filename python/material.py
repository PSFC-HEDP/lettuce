...
LILAC_SOLID_MATERIALS = {
	...
	"diamond": Material(6, eos=6, ionization=2, opacity=1, density=3.5),
	"HDC": Material(6, eos=6, ionization=2, opacity=1, density=3.5),
	...
	"CH": Material(110, eos=8, ionization=1, opacity=8),
	"strong CD": Material(113, eos=8, ionization=1, opacity=8),
	"CD": Material(115, eos=8, ionization=1, opacity=1),
	"SiO2": Material(150, eos=6, ionization=1, opacity=1),
	"glass": Material(150, eos=6, ionization=1, opacity=1),
